/*
 ...
 Source Schema         : lose_found

 Target Server Type    : MySQL
 Target Server Version : 50553
 File Encoding         : 65001

 Date: 16/11/2019 20:44:12
*/
...
CREATE TABLE `manager`  (
  ...
  `create_time` datetime NULL DEFAULT NULL,
  `update_time` datetime NULL DEFAULT NULL,
  `current_time` datetime NOT NULL COMMENT '最后一次的登录时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Compact;
...
CREATE TABLE `post`  (
  ...
  `lose_time` datetime NULL DEFAULT NULL COMMENT '丢失的时间',
  ...
  `create_time` datetime NULL DEFAULT NULL COMMENT '消息发布时间',
...
CREATE TABLE `user`  (
  ...
  `sno` varchar(0) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  ...
  `create_time` datetime NULL DEFAULT NULL,
  `update_time` datetime NULL DEFAULT NULL COMMENT '用户资料变更时间',
  `current_time` datetime NULL DEFAULT NULL COMMENT '用户最后在线时间',
  `status` int(10) NULL DEFAULT NULL COMMENT '-1-删除  0-是正常 1-是封禁 ',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Compact;
